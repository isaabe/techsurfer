          ...
          <form action="https://formbold.com/s/FORM_ID" method="POST" className="py-6 px-9">
            ...
            <div className="mb-5">
              ...
              <textarea
                ...
                className="w-full resize-none rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border
                -[#6A64F1] focus:shadow-md"/>
</div>
<button type="submit" className="w-full bg-[#6A64F1] text-white py-3 px-6 rounded-md text-base font-medium" >
Submit
</button>
</form>
</div>
