        ...
        <div className="bg-white shadow-lg flex flex-col items-center rounded-xl overflow-hidden lg:flex-row lg:w-2/3 2xl:w-1/2">
          ...
          <div className="p-8 lg:w-1/2 sm:p-8">
            ...
            <form action="" className="flex flex-col">
              ...
              <button className="my-6 bg-blue-600 hover:bg-blue-700 text-white font-medium text-lg px-4 py-2 rounded-md">Login</button>
            </form>
            <p className="text-gray-500">Don't have an account? <a href="#" className="text-blue-500 font-semibold underline">Sign up</a></p>
          </div>
          {/* image */}
          <div className="w-1/2">
            <img src="assets/login.jpeg" alt="" className="h-full lg:block hidden" />
          </div>
        </div>
      </main>
    );
